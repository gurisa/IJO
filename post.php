...
<tr>
<td width="80%">
<table width="100%" height="250px" border="0" bordercolor="black" cellpading="0" cellspacing="0">
<tr>
<td>
<table width="100%" height="250px" border="0" bordercolor="black" cellpading="0" cellspacing="0">
<tr>
<td width="80%">
<center>
<table class="shadow" width="80%" height="250px" border="1" bordercolor="black" cellpading="0" cellspacing="0">
<tr>
<td height="5px">
<b>RESUME TITLE</b>
<input type="text" size="40px" maxlength="250"></input>
<b>SKILL</b>
<select name="">
<option value="" name="" id="">WEB PROGRAMMING</option>
<option value="" name="" id="">GET DATA FROM DATABASE</option>
</select>
</td>
</tr>
<tr>
