...
<tr>
<td>
<table class="shadow" width="99%" height="640px" border="1" bordercolor="black" cellpading="0" cellspacing="0">
<tr>
<td>
<center>
<table class="shadow" width="98%" height="100px" border="1" bordercolor="black" cellpading="0" cellspacing="0">
<tr>
<th height="5px" colspan="2" width="151px">
ADMIN PROFILE
</th>
<tr>
<td>
<img src="/image/koala.jpg" width="150px" height="150px" alt="Profile"></img>
</td>
<td width="80%">
PASSWORD
***
...
<td>
<select name="">
<option value="" id="" name="">JAWA BARAT</option>
<option value="" id="" name="">ADD DATA FROM DATABASE</option>
</select>
<p>
ADD PROVINCE
